...
const PlayersPanel = () => {
  return (
    <div className="h-56 fixed bottom-0 lg:h-[95%] w-full lg:-top-3 lg:left-48 lg:relative bg-logoTheme lg:w-1/4 shadow-xl flex flex-col justify-start items-center px-5 pt-2 lg:bg-[#b67cd3]">
